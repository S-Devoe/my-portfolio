        ...
        <div className="portfolio_slug_detail">
          ...
          <div className="project_info">
            <div className="project_intro">
              <h2 className="project_intro_headline">{project.name}</h2>
              <p className="project_intro_description">{project.excerpt}</p>
            ...
            <div className="project_background">
              <h3 className="project_background-headline">
                Project Background
              </h3>
              <p
                className="project_background-description"
          ...
          <div className="previousProject">
            ...
            >
              <a className="portfolio_pagination_previous">
                ...
                <p className="portfolio_pagination_direction">
                  Previous Project
                </p>
              </a>
            </Link>
